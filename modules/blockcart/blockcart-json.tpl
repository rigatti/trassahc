...
{assign var='productAttributeId' value=$product.id_product_attribute}
	{ldelim}
		...
		{if $isProfesional}
			"priceByLine":   "{displayWtPrice|html_entity_decode:2:'UTF-8' p=($product.wholesale_price * $product.cart_quantity|intval)}",
			"price":         "{displayWtPrice|html_entity_decode:2:'UTF-8' p=($product.wholesale_price * $product.cart_quantity|intval)}",
			"price_float":   "{$product.wholesale_price * $product.cart_quantity|intval}",
		{else}
...
{if $isProfesional}
	"total": "{$total_pro|html_entity_decode:2:'UTF-8'}",
{else}
