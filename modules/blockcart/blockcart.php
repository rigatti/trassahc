...
class BlockCart extends Module
{
	...
	public function assignContentVars($params)
	{
		...
		$totalToPay_pro = $params['cart']->getOrderTotalWholeSale($useTax);
		...
		$this->smarty->assign(array(
				...
				'total_pro' => Tools::displayPrice($totalToPay_pro, $currency), // isprofesional
				'order_process' => Configuration::get('PS_ORDER_PROCESS_TYPE') ? 'order-opc' : 'order',
				'ajax_allowed' => (int)(Configuration::get('PS_BLOCK_CART_AJAX')) == 1 ? true : false,
				'static_token' => Tools::getToken(false),
				'free_shipping' => $total_free_shipping,
				'isProfesional' => (Group::getCurrent()->id == 4)
		));
		if (count($errors))
