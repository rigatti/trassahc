...
class BlockUserInfo extends Module
{
	...
	public function hookDisplayTop($params)
	{
		...
		/* [RM - START]*/
		if (file_exists(_PS_THEME_DIR_.'modules/blockuserinfo/blockuserinfo.tpl'))
			return $this->display(_PS_THEME_DIR_.'modules/blockuserinfo/', 'blockuserinfo.tpl');
		else
	...
	{
		/*[RM - START]*/
		$this->context->controller->addCSS(_THEME_CSS_DIR_.'blockuserinfo.css', 'all');
		/*[RM - END]*/
