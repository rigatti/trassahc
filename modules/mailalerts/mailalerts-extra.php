{* * 2007-2014 PrestaShop * * NOTICE OF LICENSE * * This source file is
...
for more information. * * @author PrestaShop SA
<contact @prestashop.com> * @copyright 2007-2014 PrestaShop SA *
...
PrestaShop SA *} <script type="text/javascript">
...
</script> {if !$isCustomerMailAlert AND $isLogged}
<li id="mailalerts_block_extra_add" class="add">{l s='Add this product
	to my favorites' mod='mailalerts'}</li>
{/if} {if $isCustomerMailAlert AND $isLogged}
<li id="mailalerts_block_extra_remove">{l s='Remove this product from my
	favorites' mod='mailalerts'}</li>
{/if}

<li id="mailalerts_block_extra_added">{l s='Remove this product from my
	favorites' mod='mailalerts'}</li>
<li id="mailalerts_block_extra_removed">{l s='Add this product to my
	favorites' mod='mailalerts'}</li>