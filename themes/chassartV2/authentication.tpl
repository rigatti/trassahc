	...
	<form action="{$link->getPageLink('authentication', true)|escape:'html'}" method="post" id="create-account_form" class="std">
		<fieldset>
			...
			<div class="form_content clearfix">
				<p class="testtitle_block">{l s='Please enter your email address to create an account.'}</p>
		...
		<fieldset>
			...
			<div id="opc_account_form" style="display: block; ">
				...
				<p style="text-align:center">
					<br> <br>
					Si vous disposez d'une r&eacute;f&eacute;rence et d'un code sur votre facture, indiquez les ci-dessous
				</p>
				<p class="text">
					<label for="catref">R&eacute;f&eacute;rence Client</label>
					<input type="text" name="catref" id="catref" value="{$smarty.post.catref}" />
				</p>
				<p class="text">
					<label for="catcode">Code Client</label>
					<input type="text" name="catcode" id="catcode" value="{$smarty.post.catcode}" />
				</p>
