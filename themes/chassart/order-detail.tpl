...
<ul class="address item {if $order->isVirtual()}full_width{/if}">
	<li class="address_title">Adresse</li>
	...
	<table class="std">
		...
		<!--tfoot>
			<tr class="totalprice item">
				<td align="right" colspan="{if $return_allowed || $order->hasProductReturned()}{if $order->hasProductReturned() && $return_allowed}7{else}6{/if}{else}5{/if}">
