...
{/if}
	...
	{if !$content_only}
		...
		<div id="page" class="container_9 clearfix">
			<!-- Header -->
			<div id="header" class="grid_9 alpha omega" style="background: rgba(0, 0, 0, 0) url(../img/logo_homepage.jpg) no-repeat scroll 0 0 / 300px 200px; height:200px;width:1000px;">
				********************************************
