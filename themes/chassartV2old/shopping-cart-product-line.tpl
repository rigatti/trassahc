...
<tr id="product_{$product.id_product}_{$product.id_product_attribute}_{if $quantityDisplayed > 0}nocustom{else}0{/if}_{$product.id_address_delivery|intval}{if !empty($product.gift)}_gift{/if}" class="cart_item{if isset($productLast) && $productLast && (!isset($ignoreProductLast) || !$ignoreProductLast)} last_item{/if}{if isset($productFirst) && $productFirst} first_item{/if}{if isset($customizedDatas.$productId.$productAttributeId) AND $quantityDisplayed == 0} alternate_item{/if} address_{$product.id_address_delivery|intval} {if $odd}odd{else}even{/if}">
	...
	<td class="cart_unit">
		<span class="price" id="product_price_{$product.id_product}_{$product.id_product_attribute}{if $quantityDisplayed > 0}_nocustom{/if}_{$product.id_address_delivery|intval}">
			{if $isProfessional}
				<p class="s_title_block">Professionnel : <span id="cartProductPriceHtva_{$product.id_product}_{$product.id_product_attribute}{if $quantityDisplayed > 0}_nocustom{/if}_{$product.id_address_delivery|intval}">{convertPrice price=$product.wholesale_price}</span> HTVA</p>
				<font style="font-size:10px;font-style:italic;">Particulier : <span id="cartProductPriceTvac_{$product.id_product}_{$product.id_product_attribute}{if $quantityDisplayed > 0}_nocustom{/if}_{$product.id_address_delivery|intval}">{convertPrice price=$product.price_without_specific_price}</span> TVAC</font>
			{else}
				<span id="cartProductPriceTvac_{$product.id_product}_{$product.id_product_attribute}{if $quantityDisplayed > 0}_nocustom{/if}_{$product.id_address_delivery|intval}">{convertPrice price=$product.price_without_specific_price}</span>
				<span id="cartProductPriceHtva_{$product.id_product}_{$product.id_product_attribute}{if $quantityDisplayed > 0}_nocustom{/if}_{$product.id_address_delivery|intval}" style="display:none"></span>
			{/if}
		</span>
	</td>
	...
	<td class="cart_total">
		<span class="price" id="total_product_price_{$product.id_product}_{$product.id_product_attribute}{if $quantityDisplayed > 0}_nocustom{/if}_{$product.id_address_delivery|intval}{if !empty($product.gift)}_gift{/if}">
			...
			{else}
				...
				{else}
					{if $isProfessional}
						<p class="s_title_block"><span id="total_product_price_HTVA_{$product.id_product}_{$product.id_product_attribute}{if $quantityDisplayed > 0}_nocustom{/if}_{$product.id_address_delivery|intval}">{convertPrice price=($product.wholesale_price * $product.cart_quantity)}</span> HTVA</p>
						<font style="font-size:10px;font-style:italic;"><span id="total_product_price_TVAC_{$product.id_product}_{$product.id_product_attribute}{if $quantityDisplayed > 0}_nocustom{/if}_{$product.id_address_delivery|intval}">{convertPrice price=($product.price_without_specific_price * $product.cart_quantity)}</span> TVAC</font>
					{else}
						<p class="s_title_block"><span id="total_product_price_TVAC_{$product.id_product}_{$product.id_product_attribute}{if $quantityDisplayed > 0}_nocustom{/if}_{$product.id_address_delivery|intval}">{convertPrice price=$product.total_wt}</span></p>
						<span style="display:none" id="total_product_price_HTVA_{$product.id_product}_{$product.id_product_attribute}{if $quantityDisplayed > 0}_nocustom{/if}_{$product.id_address_delivery|intval}"></span>
					{/if}
				{/if}
			{/if}
		</span>
