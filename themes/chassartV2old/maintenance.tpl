...
{/if}
	...
	<body>
		<div id="maintenance">
			 ...
			 <p style="margin-top: 0px; margin-bottom: 0px;"><img src="{$logo_url}" {if $logo_image_width}width="{$logo_image_width}"{/if} {if $logo_image_height}height="{$logo_image_height}"{/if} alt="logo" /><br /><br /></p>
			 {$HOOK_MAINTENANCE}
			 <p id="message">
